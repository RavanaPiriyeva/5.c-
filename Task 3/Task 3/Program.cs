            ...
            for (int i = 0; i < size; i++)
            {
                ...
                while (x)
                {
                    ...
                    for (int j = 0; j < i; j++)
                    {
                        ...
                        {
                            Console.WriteLine("Bu nomre artiq daxil edilib!!!    Ferqli nomre daxil et !!!");
                            x = true;
                        }
                        else
                        {
                ...
                while (name.Length < 1 || name.Length > 50)
                {
                    ...
                    Console.WriteLine("Kitabin adini yazin :   (adda simvol sayi  1-den 50-ye kimi ola biler )");
                ...
                while (genre.Length < 3 || genre.Length > 20)
                {
                    ...
                    Console.WriteLine("JANIRI DUZGUN DAXIL EDIN !!!");
                }
                while (price <= 0)
                {
